 ...
 * 
 * Esta função recebe como parâmetro dois números inteiros que representam o início e o 
 * fim de um intervalo, e dois ponteiros para inteiros que receberão os valores do maior e do menor número primo encontrado no intervalo.
 * 
