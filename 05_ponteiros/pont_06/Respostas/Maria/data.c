...
void LeData( tData *data )
{
   ...
   tData dataTeste = {dia, mes, ano};

    if(dia > InformaQtdDiasNoMes(&dataTeste)){
        dia = InformaQtdDiasNoMes(&dataTeste);
    }
...
int InformaQtdDiasNoMes( tData *data )
{
    ...
    //mes 30: abril-4, jun, set, nov
    if(data->mes == 4 || data->mes == 6 || data->mes == 9 || data->mes == 11)
        return 30;
    
        //mes 31: jan-1, mar-3, maio-, jul, ago, out, dez
    if(data->mes == 1 || data->mes == 3 || data->mes == 7 || data->mes == 8 || data->mes == 10 || data->mes == 12)
        return 31;
